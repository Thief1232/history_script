...
По умолчанию скрипт показывает 10 самых посещаемых доменов.
...
- вывод количества посезений над колонкой
- разные цвета для колонок
- добавить колонку с остальными сайтами
